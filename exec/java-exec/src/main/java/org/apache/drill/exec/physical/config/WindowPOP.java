...
public class WindowPOP extends AbstractSingle {
  ...
  private final boolean isLastWindow;
  ...
  public WindowPOP(@JsonProperty("child") PhysicalOperator child,
                   ...
                   @JsonProperty("isLastWindow") boolean isLastWindow) {
    super(child);
  ...
  protected PhysicalOperator getNewWithChild(PhysicalOperator child) {
    return new WindowPOP(child, withins, aggregations, start, end, isLastWindow);
  }
