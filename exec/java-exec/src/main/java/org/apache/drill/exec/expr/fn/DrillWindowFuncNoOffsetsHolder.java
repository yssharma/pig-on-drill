...
class DrillWindowFuncNoOffsetsHolder extends DrillFuncHolder{
  ...
  public DrillWindowFuncNoOffsetsHolder(FunctionScope scope, NullHandling nullHandling, boolean isBinaryCommutative, boolean isRandom,
