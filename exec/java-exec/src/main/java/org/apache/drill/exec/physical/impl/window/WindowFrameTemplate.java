...
public abstract class WindowFrameTemplate implements WindowFramer {
  private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(WindowFramer.class);
  ...
  public AggOutcome doWork() {
    ...
    try {
      ...
      outside: while (true) {
        ...
        logger.trace("Exit Loop from underlying index {}, previous {}, current {}", underlyingIndex, previousIndex, currentIndex);
